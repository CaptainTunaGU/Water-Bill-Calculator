...
#include <stdio.h>
 ...
 #define over_chg_rate 2     /* double use charger as conservation penalty */
 ...
 scanf("%d", &current);
 printf("Enter last year quarter usage> ");
